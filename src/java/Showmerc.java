...
public class Showmerc extends HttpServlet {
       ...
       PrintWriter out = response.getWriter();
        ...
        try {
            ...
            try (Connection con = DriverManager.getConnection(conURL , dbusername, dbuserpassword);
                 ...
                 ResultSet resultSet = statement.executeQuery("SELECT * FROM merchandise")) {
                ...
                while(resultSet.next()){
                    String merchName = resultSet.getString("merchandise_name");
                    int price = resultSet.getInt("price");
                    int merchId = resultSet.getInt("merch_id");
                    out.println("<tr><td>" + merchName + "</td><td>" + price + "</td><td>" + merchId+ "</td></tr>");   
                }
